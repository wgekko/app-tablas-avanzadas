...
# --- Carga de datos del archivo Excel (.xlsx) ---
NOMBRE_ARCHIVO_EXCEL = 'datos/tasa de desocupacion segun caracteristicas socioecnomicas-actualizado190825.xlsx'
...
with st.expander("Modelo Estadístico Avanzado", expanded=False, icon=":material/work_alert:", width="stretch"):
    ...
    # ----------------------------
    FILE_PATH = "datos/tasa de desocupacion segun caracteristicas socioecnomicas-actualizado190825.xlsx"

    st.header("Dashboard Estadístico Avanzado — Tasa de Desocupación")
