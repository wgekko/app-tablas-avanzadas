...
st.set_page_config(layout="wide", page_title="Analsis Tasa Subocupación", page_icon="icons/trabajar.png")
...
# --- Carga de datos del archivo Excel (.xlsx) ---
NOMBRE_ARCHIVO_EXCEL = 'datos/tasa de subocupacion segun caracteristicas socioeconomicas-actualizado190825.xlsx'
...
with st.expander("Modelo Estadístico Avanzado", expanded=False, icon=":material/work_alert:", width="stretch"):
    ...
    # ----------------------------
    FILE_PATH = "datos/tasa de subocupacion segun caracteristicas socioeconomicas-actualizado190825.xlsx"
